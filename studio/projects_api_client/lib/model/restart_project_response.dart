...
class RestartProjectResponse {
  /// Returns a new [RestartProjectResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RestartProjectResponse &&
    other.action == action &&
  ...
  /// Returns a new [RestartProjectResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RestartProjectResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RestartProjectResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RestartProjectResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RestartProjectResponse(
  ...
  static List<RestartProjectResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RestartProjectResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RestartProjectResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RestartProjectResponse> mapFromJson(dynamic json) {
    final map = <String, RestartProjectResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RestartProjectResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RestartProjectResponse-objects as value to a dart map
  static Map<String, List<RestartProjectResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RestartProjectResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RestartProjectResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
