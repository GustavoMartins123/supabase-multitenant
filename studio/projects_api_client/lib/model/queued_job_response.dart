...
class QueuedJobResponse {
  /// Returns a new [QueuedJobResponse] instance.
  QueuedJobResponse({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is QueuedJobResponse &&
    other.action == action &&
  ...
  /// Returns a new [QueuedJobResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static QueuedJobResponse? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<QueuedJobResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <QueuedJobResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = QueuedJobResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, QueuedJobResponse> mapFromJson(dynamic json) {
    final map = <String, QueuedJobResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = QueuedJobResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of QueuedJobResponse-objects as value to a dart map
  static Map<String, List<QueuedJobResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<QueuedJobResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = QueuedJobResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
