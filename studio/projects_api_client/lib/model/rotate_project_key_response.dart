...
class RotateProjectKeyResponse {
  /// Returns a new [RotateProjectKeyResponse] instance.
  RotateProjectKeyResponse({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RotateProjectKeyResponse &&
    other.action == action &&
  ...
  /// Returns a new [RotateProjectKeyResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RotateProjectKeyResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RotateProjectKeyResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RotateProjectKeyResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RotateProjectKeyResponse(
  ...
  static List<RotateProjectKeyResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RotateProjectKeyResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RotateProjectKeyResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RotateProjectKeyResponse> mapFromJson(dynamic json) {
    final map = <String, RotateProjectKeyResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RotateProjectKeyResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RotateProjectKeyResponse-objects as value to a dart map
  static Map<String, List<RotateProjectKeyResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RotateProjectKeyResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RotateProjectKeyResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
