...
class CreateRestorePointResponse {
  /// Returns a new [CreateRestorePointResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateRestorePointResponse &&
    other.action == action &&
  ...
  /// Returns a new [CreateRestorePointResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateRestorePointResponse? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreateRestorePointResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreateRestorePointResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateRestorePointResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateRestorePointResponse> mapFromJson(dynamic json) {
    final map = <String, CreateRestorePointResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateRestorePointResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CreateRestorePointResponse-objects as value to a dart map
  static Map<String, List<CreateRestorePointResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateRestorePointResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateRestorePointResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
