...
class StartProjectResponse {
  /// Returns a new [StartProjectResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is StartProjectResponse &&
    other.action == action &&
  ...
  /// Returns a new [StartProjectResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static StartProjectResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "StartProjectResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "StartProjectResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<StartProjectResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <StartProjectResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = StartProjectResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, StartProjectResponse> mapFromJson(dynamic json) {
    final map = <String, StartProjectResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = StartProjectResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of StartProjectResponse-objects as value to a dart map
  static Map<String, List<StartProjectResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<StartProjectResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = StartProjectResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
