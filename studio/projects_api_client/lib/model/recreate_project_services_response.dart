...
class RecreateProjectServicesResponse {
  /// Returns a new [RecreateProjectServicesResponse] instance.
  RecreateProjectServicesResponse({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RecreateProjectServicesResponse &&
    other.action == action &&
  ...
  /// Returns a new [RecreateProjectServicesResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RecreateProjectServicesResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RecreateProjectServicesResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RecreateProjectServicesResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RecreateProjectServicesResponse(
  ...
  static List<RecreateProjectServicesResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RecreateProjectServicesResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RecreateProjectServicesResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RecreateProjectServicesResponse> mapFromJson(dynamic json) {
    final map = <String, RecreateProjectServicesResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RecreateProjectServicesResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RecreateProjectServicesResponse-objects as value to a dart map
  static Map<String, List<RecreateProjectServicesResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RecreateProjectServicesResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RecreateProjectServicesResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
