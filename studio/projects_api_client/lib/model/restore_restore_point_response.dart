...
class RestoreRestorePointResponse {
  /// Returns a new [RestoreRestorePointResponse] instance.
  RestoreRestorePointResponse({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RestoreRestorePointResponse &&
    other.action == action &&
    ...
    other.safetyPointId == safetyPointId &&
  ...
  @override
  String toString() => 'RestoreRestorePointResponse[action=$action, attempt=$attempt, createdAt=$createdAt, createdBy=$createdBy, currentStep=$currentStep, errorCode=$errorCode, finishedAt=$finishedAt, isIdempotent=$isIdempotent, jobId=$jobId, message=$message, progress=$progress, project=$project, projectUuid=$projectUuid, queuePosition=$queuePosition, restorePointId=$restorePointId, retryOf=$retryOf, retryable=$retryable, safetyPointId=$safetyPointId, startedAt=$startedAt, status=$status, tenantUuid=$tenantUuid, totalSteps=$totalSteps, updatedAt=$updatedAt]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.retryOf != null) {
      ...
      json[r'safety_point_id'] = this.safetyPointId;
  ...
  /// Returns a new [RestoreRestorePointResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RestoreRestorePointResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RestoreRestorePointResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RestoreRestorePointResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RestoreRestorePointResponse(
        ...
        safetyPointId: mapValueOfType<String>(json, r'safety_point_id')!,
  ...
  static List<RestoreRestorePointResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RestoreRestorePointResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RestoreRestorePointResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RestoreRestorePointResponse> mapFromJson(dynamic json) {
    final map = <String, RestoreRestorePointResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RestoreRestorePointResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RestoreRestorePointResponse-objects as value to a dart map
  static Map<String, List<RestoreRestorePointResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RestoreRestorePointResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RestoreRestorePointResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
