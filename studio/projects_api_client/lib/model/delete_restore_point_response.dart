...
class DeleteRestorePointResponse {
  /// Returns a new [DeleteRestorePointResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DeleteRestorePointResponse &&
    other.action == action &&
  ...
  /// Returns a new [DeleteRestorePointResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DeleteRestorePointResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DeleteRestorePointResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DeleteRestorePointResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return DeleteRestorePointResponse(
  ...
  static List<DeleteRestorePointResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DeleteRestorePointResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DeleteRestorePointResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DeleteRestorePointResponse> mapFromJson(dynamic json) {
    final map = <String, DeleteRestorePointResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DeleteRestorePointResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DeleteRestorePointResponse-objects as value to a dart map
  static Map<String, List<DeleteRestorePointResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DeleteRestorePointResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DeleteRestorePointResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
