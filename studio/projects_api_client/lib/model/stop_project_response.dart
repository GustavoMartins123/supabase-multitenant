...
class StopProjectResponse {
  /// Returns a new [StopProjectResponse] instance.
  StopProjectResponse({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is StopProjectResponse &&
    other.action == action &&
  ...
  /// Returns a new [StopProjectResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static StopProjectResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "StopProjectResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "StopProjectResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<StopProjectResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <StopProjectResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = StopProjectResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, StopProjectResponse> mapFromJson(dynamic json) {
    final map = <String, StopProjectResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = StopProjectResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of StopProjectResponse-objects as value to a dart map
  static Map<String, List<StopProjectResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<StopProjectResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = StopProjectResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
