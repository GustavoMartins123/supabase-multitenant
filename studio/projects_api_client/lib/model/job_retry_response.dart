...
class JobRetryResponse {
  /// Returns a new [JobRetryResponse] instance.
  JobRetryResponse({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is JobRetryResponse &&
    other.action == action &&
  ...
  /// Returns a new [JobRetryResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static JobRetryResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return JobRetryResponse(
        ...
        queuePosition: mapValueOfType<int>(json, r'queue_position') ?? 0,
  ...
  static List<JobRetryResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <JobRetryResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = JobRetryResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, JobRetryResponse> mapFromJson(dynamic json) {
    final map = <String, JobRetryResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = JobRetryResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of JobRetryResponse-objects as value to a dart map
  static Map<String, List<JobRetryResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<JobRetryResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = JobRetryResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
