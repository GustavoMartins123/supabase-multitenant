...
docker compose -f docker-compose-api.yml --env-file secrets/.env --env-file .env down
docker compose -f docker-compose.yml --env-file .env --env-file secrets/.env down
