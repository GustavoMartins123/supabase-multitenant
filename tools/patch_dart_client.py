"""Corrige dois bugs de template do openapi-generator (dart) sobre o spec 3.1.

1. Modelos vazios extraídos de anyOf: o construtor `X({\n  });` é
...
def patch(path: pathlib.Path) -> dict[str, int]:
    ...
    counts = {"empty_equals": 0, "empty_ctor": 0, "empty_hashcode": 0, "enum_fallback": 0}
...
def main() -> int:
    if not MODEL_DIR.is_dir():
        ...
        return 1
    total = {"empty_equals": 0, "empty_ctor": 0, "empty_hashcode": 0, "enum_fallback": 0}
    touched: list[str] = []
